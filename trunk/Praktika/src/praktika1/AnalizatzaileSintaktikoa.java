...
// /
	        ...
	        private void parametroak_gehitu(String par_mota_balioa,
					String mota_mota,
					Vector<String> ident_zerrenda_izenak) { // Berria //

String azken_param_mota = new String();

azken_param_mota = par_mota_balioa + "_" + mota_mota;
