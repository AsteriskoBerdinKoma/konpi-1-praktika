...
//////////////////////////////////////////////////////////////////////////////	/
	        ...
	        private String Ad_bakuna_prima(String ad_bakuna_prima_hi)    {
	                ...
	                if (look.T_token().equals("+")) {
	                  ...
	                  ad_bakuna_prima1_izena = Ad_bakuna_prima(ad_bakuna_prima1_hi);
	                  ad_bakuna_prima_izena = ad_bakuna_prima1_izena;
	                }
	                else if (look.T_token().equals("-")) {
	                    Emparejar("-");
	                    gaia_izena = Gaia();
	                    ...
	                    ad_bakuna_prima_izena = ad_bakuna_prima_hi;
	                }
	                
	                return ad_bakuna_prima_izena;
	        ...
	        private void Parametro_zerrendaren_bestea(){       
	         ...
	         String Parmota_mota = new String();
	         String mota_mota = new String();
	         Vector ident_zerrenda_izenak = new Vector();


	        if (look.Str_token().equals(";")){
	              Emparejar(";");
	              ident_zerrenda_izenak = Ident_zerrenda();
	            
	              Emparejar(":");
	              
	              Parmota_mota = Par_mota();
	              mota_mota = Mota();

	              
	              parametro_zerrenda_gehitu(ident_zerrenda_izenak,Parmota_mota,mota_mota);
	        ...
	        private String Par_mota_prima(){  
	          ...
	          String Parmota_prima_mota = new String("");

	          if (look.Str_token().equals("out")) {
	            Emparejar("out");
	            Parmota_prima_mota="ald";
	          }
	          else Parmota_prima_mota="bal"; 

	          return Parmota_prima_mota;
	        ...
	        private String Par_mota(){  
	          ...
	          else { //if (look.Str_token().equals("in"))
	            Emparejar("in");
	            Parmota_mota = Par_mota_prima(); 
	            }
	        ...
	        private void Azpiprogramen_erazagupena(){ 
	          ...
	          if (look.Str_token().equals("procedure")){
	        ...
	        private String Mota() {
	                ...
	                if (look.Str_token().equals("integer")) {
	                    Emparejar("integer");
	                    mota_mota = "int";
	                }
	                else {
