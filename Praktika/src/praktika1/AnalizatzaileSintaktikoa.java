	...
	public class Asintak {
		...
		private String Gaia_prima(String gaia_prima_hi) {
			...
			if (look.getTokenMota().equals("*")) {
				...
				codigo.Ag_gehitu(gaia_prima1_hi + ":= " + gaia_prima_hi + " * "
						+ faktore_izena + ";");
		...
		private String Ad_bakuna_prima(String ad_bakuna_prima_hi) {
			...
			if (look.getTokenMota().equals("+")) {
				...
				codigo.Ag_gehitu(ad_bakuna_prima1_hi + ":= "
		...
		private A Adierazpena() {
			...
			codigo
					.Ag_gehitu("if " + adierazpen_bakuna1_izena + " "
							+ erag_erl_mota + " " + adierazpen_bakuna2_izena
							+ " goto ");
		...
		private int M() {
			return codigo.Obten_ref_codigo();
		} // end M
		...
		private Atrib S_if() {
			...
			sententzia_break.Copiar_lcont(Bildu(sententzia_zerrenda1_break
					.lcont(), sententzia_zerrenda2_break.lcont()));
			return sententzia_break;
		...
		private Atrib Sententzia() {
			...
			if (look.getTokenMota().equals("ID")) {
				...
				adierazpen_bakuna_izena = Adierazpen_bakuna();
				match(";");
				codigo.Ag_gehitu(aldagaia_izena + ":="
						+ adierazpen_bakuna_izena + ";");
